...
class ArnDiffAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(ArnDiffAgent, self).__init__()
        self.args = args
        ...
        self.enemies_info_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // 2)
        self.enemies_info_fc2 = nn.Linear(args.arn_hidden_size // 2, args.arn_hidden_size)

        self.enemies_info2_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // 2)
        self.enemies_info2_fc2 = nn.Linear(args.arn_hidden_size // 2 , args.arn_hidden_size)
