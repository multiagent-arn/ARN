...
class ArnDiffWoShareAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(ArnDiffWoShareAgent, self).__init__()
        self.args = args
        ...
        # For 2s3z
        self.enemies_info_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // self.args.enemies_num)
        self.enemies_info_fc2 = nn.Linear(args.arn_hidden_size // self.args.enemies_num, args.arn_hidden_size)

        self.enemies_info2_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // self.args.enemies_num)
        self.enemies_info2_fc2 = nn.Linear(args.arn_hidden_size // self.args.enemies_num, args.arn_hidden_size)

        self.enemies_info3_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // self.args.enemies_num)
        self.enemies_info3_fc2 = nn.Linear(args.arn_hidden_size // self.args.enemies_num, args.arn_hidden_size)

        self.enemies_info4_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // self.args.enemies_num)
        self.enemies_info4_fc2 = nn.Linear(args.arn_hidden_size // self.args.enemies_num, args.arn_hidden_size)

        self.enemies_info5_fc1 = nn.Linear(args.enemy_feats_size, args.arn_hidden_size // self.args.enemies_num)
        self.enemies_info5_fc2 = nn.Linear(args.arn_hidden_size // self.args.enemies_num, args.arn_hidden_size)
